          ...
          <div className="grid w-full items-center gap-4">
            <div className="flex flex-col space-y-1.5">
              ...
              <div className="relative">
                <Input id="apiKey" readOnly type={showKey ? "text": "password"} value="abc123def456ghi789" />
                <Button
                  ...
                  >
                    {showKey ? <EyeIcon className="h-4 w-4" /> : <EyeSlashIcon className="h-4 w-4" />}
                ...
                <Tooltip>
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      e.preventDefault(); 
                      navigator.clipboard.writeText("abc123def456ghi789") //text to be replace with the actual API Key
                      setHasCopied(true)
                    }}
                  >
